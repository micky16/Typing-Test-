...
let congos_ref = document.querySelector(".cong-section")
let display_ref = document.querySelector('#display');
let reset_ref = document.querySelector('reset');
// --------------------------------</References>
...
input_ref.addEventListener('keyup', function(event) {
    ...
    if (timer > 0) {
        if (heading_t === input_typed) {
            alert("hii");
            display_ref.style.display = 'none';
            congos_ref.style.display = "block";
